...
const PrivacyPolicy = () => (
  <PrivacyPolicyContent>
    ...
    <h1>Greetings From Martha's Vineyard Tours Privacy Policy</h1>
    ...
    <p>We collect information from you when you enter information on our site.</p>

    <h3>How do we use your information?</h3>

    <p>We may use the information we collect from you when you register, make a purchase, sign up for our newsletter, respond to a survey or marketing communication, surf the website, or use certain other site features for marketing purposes or in order to improve the website.</p>
    ...
    <p>We use cookies for tracking purposes on our website.</p>

    <p>You can choose to have your computer warn you each time a cookie is being sent, or you can choose to turn off all cookies. You do this through your browser settings. Since each browser is a little different, look at your browser's Help Menu to determine the correct way to modify your cookies.</p>
    ...
    <p>Third-party vendors such as Google use first-party cookies (such as the Google Analytics cookies) and third-party cookies or other third-party identifiers together to compile data regarding user interactions with ad impressions and other ad service functions as they relate to our website.</p>
    ...
    <ul>
      ...
      <li>You can change your personal information:
        <ul>
    ...
    <p>We do not allow third-parties to advertise or collect PII from children under 13.</p>
    ...
    <p>If at any time you would like to unsubscribe from receiving future emails, you can follow the directions at the bottom of emails or email us at <a target="_blank" rel="noopener noreferrer" href="mailto:hello@mvtours.com">hello@mvtours.com</a></p>
    ...
    <address>
      <strong>Greetings From Martha's Vineyard</strong><br/>
      20 Oak Bluffs Ave<br/>
      Oak Bluffs,, Massachusetts 02557<br/>
      USA<br/>
      <a target="_blank" href="mailto:hello@toursmv.com" rel="noopener noreferrer">hello@toursmv.com</a><br/>
      <a href="tel:5086653202">(508) 665-3202</a><br/>
    </address>

    <p class="small">Last Edited on 2017-07-02</p>
  </PrivacyPolicyContent>
)
